...
{/* 2nd part */}
        ...
        <div className="col-lg-6">
              <div>
                  <img  className="img-fluid" src="https://www.w3villa.com/production/assets/landing_page/marketplace-8594c5116a383ff23cfee4c6178000ff2a9223fbb31f8d4a8ccc5ef107d99d6d.webp" alt="" />
              </div>
          </div>
